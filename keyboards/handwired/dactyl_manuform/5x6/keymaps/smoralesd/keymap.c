...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [__NSL] = LAYOUT_5x6(
        ...
        XXXXXXX,KC_SCLN,KC_P4  ,KC_P5  ,KC_P6  ,KC_PEQL,                    XXXXXXX,KC_LSFT,KC_LCTL,KC_LALT,KC_LGUI,XXXXXXX,
        XXXXXXX,KC_GRV ,KC_P1  ,KC_P2  ,KC_P3  ,KC_BSLS,                    XXXXXXX,XXXXXXX,XXXXXXX,KC_RALT,XXXXXXX,XXXXXXX,
                        XXXXXXX,XXXXXXX,                                                    XXXXXXX,XXXXXXX,
                                                KC_PDOT,KC_P0,      XXXXXXX,XXXXXXX,
                                                XXXXXXX,KC_PMNS,    XXXXXXX,XXXXXXX,
                                                XXXXXXX,XXXXXXX,    XXXXXXX,XXXXXXX
    ),
